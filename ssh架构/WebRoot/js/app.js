    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if ($(this).next().hasClass('sub-menu') == false) {
                ...
                //无下级菜单 add by hz 2014-8-29
                $(this).parent('li').addClass("active"); //当前设为活动样式
                $(this).append('<span class="selected"></span>'); //当前为选择标识 
                $(this).parents('li').siblings().removeClass('active'); //移除其它活动样式
                return;
            }
